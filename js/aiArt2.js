document.getElementById('generateImageButton2').addEventListener('click', async () => {
    const imagePrompt = document.getElementById('imagePrompt2').value;
    const imageElement = document.getElementById('generatedImage2');
